            ...
            {addresses.map((addr) => (
              ...
              >
                ...
                <div className="mt-3 flex gap-3">
                  ...
                  <button onClick={() => openEditModal(addr)} className="text-xs text-gray-400 hover:text-gray-700">
                    수정
                  </button>
                  <button onClick={() => setDeleteTargetId(addr._id)} className="text-xs text-gray-400 hover:text-red-500">
                    삭제
                  </button>
                </div>
              </li>
